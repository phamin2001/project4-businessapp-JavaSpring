...
<html>
  ...
  <header>
    ...
    <!-- <div class="subtitle"><a href="http://docs.nodejitsu.com/all">view all as single page</a></div> -->
  </header>
  ...
  <body>
    ...
    <div id="home">
      ...
      <div id="readme" class="article"><h1>docs</h1>

<p><a href="http://docs.nodejitsu.com">http://docs.nodejitsu.com</a></p>

<p><strong>community powered rocket-fuel for node.js</strong></p>

<p><img alt="docs" title="docs" src="/img/logo.png"></p>

<p>We believe in sharing knowledge. So we have assembled this growing collection of node.js how-to articles. These articles range from basic to advanced. They provide relevant code samples and insights into the design and philosophy of node itself. </p>

<p>docs.nodejitsu.com is an <a href="http://github.com/nodejitsu/docs">open source project</a> and is curated by the <a href="http:/www.nodejitsu.com">Nodejitsu</a> team and friends. If you have articles or ideas that you would like to contribute, we'd very much like to accept your pull request!</p>

<h2>Usage</h2>

<h3>Read Articles, get good at Node.js</h3>

<p>Browse /articles/ folder or <a href="http://docs.nodejitsu.com">http://docs.nodejitsu.com</a></p>

<h3>To generate the docs</h3>

<pre><code>node bin/generate</code></pre>

<h3>To start the docs server</h3>

<pre><code>node bin/server</code></pre>

<h2>Contribution Guide</h2>

<p><em>coming soon</em></p>

<h3>To add an article:</h3>

<ul><li>make a directory in <code>topics</code> for your article: <code>mkdir articles/how-to-make-an-article</code> (use only letters and dashes)</li><li>next write your article: <code>vim articles/how-to-make-an-article/article.md</code></li><li>create a metadata with this data: <code>vim articles/how-to-make-an-article/metadata.json</code></li></ul>
