...
<body>
  ...
  <div usermodel_id="article">
    ...
    <div usermodel_id="content"><p>There are two built-in timer functions, <code>setTimeout</code> and <code>setInterval</code>, which can be used to call a function at a later time. For an example usage:</p>
