...
<body>
  ...
  <div usermodel_id="article">
    <div usermodel_id="metadata">
      <h1 class="title">What are &quot;truthy&quot; and &quot;falsy&quot; values?</h1>
      <div class="date">Fri Aug 26 2011 03:08:50 GMT-0700 (PST)</div>
      <div class="author">polotek</div>
      <div>
        
      <a href="/articles" class="breadcrumb">articles</a><a href="/articles/javascript-conventions" class="breadcrumb">javascript-conventions</a><a href="/articles/javascript-conventions/what-are-truthy-and-falsy-values" class="breadcrumb">what-are-truthy-and-falsy-values</a></div>
      <!--
        <div class="tags"></div>
        <div class="difficulty"></div>
      -->
    </div>
    <div usermodel_id="content"><p>Javascript is weakly typed language. That means different types can be
used in operations and the language will try to convert the types
until the operation makes sense.</p>

<pre><code>console.log(&quot;<span class="number">1</span>&quot; &gt; <span class="number">0</span>); <span class="comment">// </span><span class="literal">true</span>, &quot;<span class="number">1</span>&quot; converted to number
console.log(<span class="number">1</span> + &quot;<span class="number">1</span>&quot;); <span class="comment">// </span><span class="number">11</span>, <span class="number">1</span> converted to string</code></pre>

<p>Type conversion also applys when values are used in unary boolean
...
<pre><code><span class="keyword">var</span> myval = &quot;value&quot;;
<span class="keyword">if</span>(myval) {
  console.log(&quot;This value is truthy&quot;);
}

myval = <span class="number">0</span>;
<span class="keyword">if</span>(!myval) {
  console.log(&quot;This value is falsy&quot;);
}</code></pre>

<p>Since most values in javascript are truthy, e.g. objects, arrays, most
numbers and strings, it's easier to identify all of the falsy
values. These are:</p>

<pre><code><span class="literal">false</span> <span class="comment">// obviously</span>
<span class="number">0</span>     <span class="comment">// The only falsy number</span>
&quot;&quot;    <span class="comment">// the empty string</span>
<span class="literal">null</span>
undefined
NaN</code></pre>

<p>Note that all objects and arrays are truthy, even empty ones.</p>

<p>Truthiness and Falsiness also come into play with logical
...
<pre><code><span class="identifier">var</span> <span class="identifier"><span class="keymethods">first</span></span> = &amp;<span class="identifier">quot</span>;<span class="identifier">truthy</span>&amp;<span class="identifier">quot</span>;
  , <span class="identifier">second</span> = &amp;<span class="identifier">quot</span>;<span class="identifier">also</span> <span class="identifier">truthy</span>&amp;<span class="identifier">quot</span>;;

<span class="identifier">var</span> <span class="identifier">myvalue</span> = <span class="identifier"><span class="keymethods">first</span></span> &amp;<span class="identifier">amp</span>;&amp;<span class="identifier">amp</span>; <span class="identifier">second</span>;
<span class="identifier">console</span>.<span class="identifier">log</span>(<span class="identifier">myvalue</span>); <span class="regexp">//</span> &amp;<span class="identifier">quot</span>;<span class="identifier">also</span> <span class="identifier">truthy</span>&amp;<span class="identifier">quot</span>;

<span class="identifier"><span class="keymethods">first</span></span> = <span class="identifier">null</span>;
<span class="identifier">second</span> = &amp;<span class="identifier">quot</span>;<span class="identifier">truthy</span>&amp;<span class="identifier">quot</span>;;

<span class="identifier">myvalue</span> = <span class="identifier"><span class="keymethods">first</span></span> || <span class="identifier">second</span>;
<span class="identifier">console</span>.<span class="identifier">log</span>(<span class="identifier">myvalue</span>); <span class="regexp">//</span> &amp;<span class="identifier">quot</span>;<span class="identifier">truthy</span>&amp;<span class="identifier">quot</span>;

<span class="identifier">myvalue2</span> = <span class="identifier">second</span> || <span class="identifier"><span class="keymethods">first</span></span>;
<span class="identifier">console</span>.<span class="identifier">log</span>(<span class="identifier">myvalue2</span>); <span class="regexp">//</span> &amp;<span class="identifier">quot</span>;<span class="identifier">truthy</span>&amp;<span class="identifier">quot</span>;

<span class="identifier">var</span> <span class="identifier">truthy</span> = &amp;<span class="identifier">quot</span>;<span class="identifier">truthy</span>&amp;<span class="identifier">quot</span>;
  , <span class="identifier">falsy</span> = <span class="number">0</span>;

<span class="identifier">myvalue</span> = <span class="identifier">truthy</span> ? <span class="identifier"><span class="keyword">true</span></span> <span class="symbol">:</span> <span class="identifier"><span class="keyword">false</span></span>;
<span class="identifier">myvalue</span> = <span class="identifier">falsy</span> ? <span class="identifier"><span class="keyword">true</span></span> <span class="symbol">:</span> <span class="identifier"><span class="keyword">false</span></span>;</code></pre></div>
  </div>
