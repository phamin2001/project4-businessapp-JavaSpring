...
<body>
  ...
  <div usermodel_id="article">
    <div usermodel_id="metadata">
      ...
      <a href="/articles" class="breadcrumb">articles</a><a href="/articles/REPL" class="breadcrumb">REPL</a><a href="/articles/REPL/how-to-create-a-custom-repl" class="breadcrumb">how-to-create-a-custom-repl</a></div>
      <!--
        <div class="tags"></div>
        <div class="difficulty"></div>
      -->
    </div>
    <div usermodel_id="content"><p>Node allows users to create their own REPLs with the <a href="http://nodejs.org/docs/v0.4.10/api/repl.html">repl module</a>. Its basic use looks like this:</p>
