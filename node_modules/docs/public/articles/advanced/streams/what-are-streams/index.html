...
<body>
  ...
  <div usermodel_id="article">
    <div usermodel_id="metadata">
      ...
      <a href="/articles" class="breadcrumb">articles</a><a href="/articles/advanced" class="breadcrumb">advanced</a><a href="/articles/advanced/streams" class="breadcrumb">streams</a><a href="/articles/advanced/streams/what-are-streams" class="breadcrumb">what-are-streams</a></div>
      <!--
        <div class="tags"></div>
        <div class="difficulty"></div>
      -->
    </div>
    <div usermodel_id="content"><p>Streams are another basic construct in node.js that encourages asynchronous coding. Streams allow you to process the data as it is generated or retrieved. Streams can be readable, writeable, or both. </p>
