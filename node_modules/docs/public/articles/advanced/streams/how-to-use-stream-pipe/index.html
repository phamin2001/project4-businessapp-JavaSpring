...
<body>
  ...
  <div usermodel_id="article">
    <div usermodel_id="metadata">
      ...
      <a href="/articles" class="breadcrumb">articles</a><a href="/articles/advanced" class="breadcrumb">advanced</a><a href="/articles/advanced/streams" class="breadcrumb">streams</a><a href="/articles/advanced/streams/how-to-use-stream-pipe" class="breadcrumb">how-to-use-stream-pipe</a></div>
      <!--
        <div class="tags"></div>
        <div class="difficulty"></div>
      -->
    </div>
    <div usermodel_id="content"><p>How to use stream.pipe</p>

<p>If you've been using node.js for a while, you've definitely run into streams.  HTTP connections are streams,  open files are streams;  stdin, stdout, and stderr are all streams as well.  A 'stream' is node's I/O abstraction - if you feel like you still need to understand them better, you can read more about them <a href="http://nodejs.org/docs/v0.4.10/api/streams.html#streams">here</a></p>
