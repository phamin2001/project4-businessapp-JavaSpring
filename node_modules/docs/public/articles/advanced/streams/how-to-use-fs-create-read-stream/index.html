...
<body>
  ...
  <div usermodel_id="article">
    <div usermodel_id="metadata">
      ...
      <a href="/articles" class="breadcrumb">articles</a><a href="/articles/advanced" class="breadcrumb">advanced</a><a href="/articles/advanced/streams" class="breadcrumb">streams</a><a href="/articles/advanced/streams/how-to-use-fs-create-read-stream" class="breadcrumb">how-to-use-fs-create-read-stream</a></div>
      <!--
        <div class="tags"></div>
        <div class="difficulty"></div>
      -->
    </div>
    <div usermodel_id="content"><p>The function <code>fs.createReadStream()</code> allows you to open up a readable stream in a very simple manner. All you have to do is pass the path of the file to start streaming in. It turns out that the response (as well as the request) objects are streams. So we will use this fact to create a http server that streams the files to the client. Since the code is simple enough, it is pretty easy just to read through it and comment why each line is necessary.</p>
