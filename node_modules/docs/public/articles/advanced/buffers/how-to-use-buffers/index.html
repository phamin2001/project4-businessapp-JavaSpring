...
<body>
  ...
  <div usermodel_id="article">
    <div usermodel_id="metadata">
      <h1 class="title">How to Use Buffers in Node.js</h1>
      <div class="date">Fri Aug 26 2011 03:08:50 GMT-0700 (PST)</div>
      <div class="author">Joshua Holbrook</div>
      <div>
        
      <a href="/articles" class="breadcrumb">articles</a><a href="/articles/advanced" class="breadcrumb">advanced</a><a href="/articles/advanced/buffers" class="breadcrumb">buffers</a><a href="/articles/advanced/buffers/how-to-use-buffers" class="breadcrumb">how-to-use-buffers</a></div>
      <!--
        <div class="tags"></div>
        <div class="difficulty"></div>
      -->
    </div>
    <div usermodel_id="content"><h2>Why Buffers?</h2>
...
<ul><li><strong>&quot;ascii&quot;</strong>: This encoding is way fast, but is limited to the ascii character set. Moreover, it will convert null characters into spaces, unlike the utf-8 encoding.</li><li><strong>&quot;ucs2&quot;</strong>: A two-byte, little-endian encoding. Can encode a subset of unicode.</li><li><strong>&quot;base64&quot;</strong>: Base64 string encoding.</li><li><strong>&quot;binary&quot;</strong>: This is the &quot;binary string&quot; format mentioned earlier, and is in the process of being deprecated. Avoid its use.</li></ul>
...
<pre><code>&amp;<span class="identifier">gt</span>; <span class="identifier">buffer</span>.<span class="identifier"><span class="keymethods">write</span></span>(&amp;<span class="identifier">quot</span>;<span class="constant">Hello</span>&amp;<span class="identifier">quot</span>;, &amp;<span class="identifier">quot</span>;<span class="identifier">utf</span>-<span class="number">8</span>&amp;<span class="identifier">quot</span>;)
...
<pre><code>&amp;<span class="identifier">gt</span>; <span class="identifier">buffer</span>.<span class="identifier"><span class="keymethods">write</span></span>(&amp;<span class="identifier">quot</span>; <span class="identifier">world!</span>&amp;<span class="identifier">quot</span>;, <span class="number">5</span>, &amp;<span class="identifier">quot</span>;<span class="identifier">utf</span>-<span class="number">8</span>&amp;<span class="identifier">quot</span>;)
...
<pre><code>&gt; <span class="keyword">var</span> snowman = &quot;☃&quot;;
&gt; snowman.length
...
<pre><code>&amp;<span class="identifier">gt</span>; <span class="identifier">var</span> <span class="identifier">buffer</span> = <span class="identifier"><span class="keymethods">new</span></span> <span class="constant">Buffer</span>(<span class="number">16</span>)
&amp;<span class="identifier">gt</span>; <span class="identifier">buffer</span>.<span class="identifier"><span class="keymethods">write</span></span>(<span class="identifier">snowman</span>)
<span class="number">3</span>
&amp;<span class="identifier">gt</span>; <span class="identifier">buffer</span>.<span class="identifier"><span class="keymethods">length</span></span>
...
&gt; <span class="keyword">var</span> snowman = <span class="keyword">new</span> Buffer(&quot;☃&quot;, &quot;utf-<span class="number">8</span>&quot;)
&gt; frosty.write(&quot;Happy birthday! &quot;, &quot;utf-<span class="number">8</span>&quot;)
<span class="number">16</span>
&gt; snowman.copy(frosty, <span class="number">16</span>)
<span class="number">3</span>
&gt; frosty.toString(&quot;utf-<span class="number">8</span>&quot;, <span class="number">0</span>, <span class="number">19</span>)
...
<pre><code>&amp;<span class="identifier">gt</span>; <span class="identifier">var</span> <span class="identifier">puddle</span> = <span class="identifier">frosty</span>.<span class="identifier"><span class="keymethods">slice</span></span>(<span class="number">16</span>, <span class="number">19</span>)
&amp;<span class="identifier">gt</span>; <span class="identifier">puddle</span>.<span class="constant">toString</span>()
<span class="string">'☃'</span>
&amp;<span class="identifier">gt</span>; <span class="identifier">puddle</span>.<span class="identifier"><span class="keymethods">write</span></span>(&amp;<span class="identifier">quot</span>;<span class="number">___</span>&amp;<span class="identifier">quot</span>;)
<span class="number">3</span>
&amp;<span class="identifier">gt</span>; <span class="identifier">frosty</span>.<span class="constant">toString</span>(&amp;<span class="identifier">quot</span>;<span class="identifier">utf</span>-<span class="number">8</span>&amp;<span class="identifier">quot</span>;, <span class="number">0</span>, <span class="number">19</span>)
<span class="string">'Happy birthday! ___'</span></code></pre>

<p>Now Frosty has been turned into a puddle of underscores. Bummer.</p></div>
  </div>
