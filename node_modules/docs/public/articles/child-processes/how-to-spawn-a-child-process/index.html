...
<body>
  ...
  <div usermodel_id="article">
    <div usermodel_id="metadata">
      ...
      <a href="/articles" class="breadcrumb">articles</a><a href="/articles/child-processes" class="breadcrumb">child-processes</a><a href="/articles/child-processes/how-to-spawn-a-child-process" class="breadcrumb">how-to-spawn-a-child-process</a></div>
      <!--
        <div class="tags"></div>
        <div class="difficulty"></div>
      -->
    </div>
    <div usermodel_id="content"><p>If you find yourself wishing you could have your Node.js process start another program for you, then look no further than the <code>child_process</code> module.</p>
