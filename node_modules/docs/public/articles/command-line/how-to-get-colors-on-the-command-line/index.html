...
<body>
  ...
  <div usermodel_id="article">
    <div usermodel_id="metadata">
      ...
      <a href="/articles" class="breadcrumb">articles</a><a href="/articles/command-line" class="breadcrumb">command-line</a><a href="/articles/command-line/how-to-get-colors-on-the-command-line" class="breadcrumb">how-to-get-colors-on-the-command-line</a></div>
      <!--
        <div class="tags"></div>
        <div class="difficulty"></div>
      -->
    </div>
    <div usermodel_id="content"><p>When working on the command line, it can be both fun and extremely useful to colorize one's output. To colorize console output, you need to use ANSI escape codes. The module <code>colors.js</code>, available on <code>npm</code>, provides an extremely easy to use wrapper that makes adding colors a breeze.</p>
