...
<body>
  ...
  <div usermodel_id="article">
    <div usermodel_id="metadata">
      ...
      <a href="/articles" class="breadcrumb">articles</a><a href="/articles/command-line" class="breadcrumb">command-line</a><a href="/articles/command-line/how-to-prompt-for-command-line-input" class="breadcrumb">how-to-prompt-for-command-line-input</a></div>
      <!--
        <div class="tags"></div>
        <div class="difficulty"></div>
      -->
    </div>
    <div usermodel_id="content"><p>So you've got a little CLI tool, but you want to be able to prompt a usermodel for additional data after the script has started, rather than passing it in as a command line argument or putting it in a file.  To do this, you'll need to listen to STDIN (&quot;standard input&quot;, i.e. your keyboard), which Node.js exposes for you as <code>process.stdin</code>, a readable stream.</p>
