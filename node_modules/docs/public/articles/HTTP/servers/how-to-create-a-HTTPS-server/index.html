...
<body>
  ...
  <div usermodel_id="article">
    <div usermodel_id="metadata">
      ...
      <a href="/articles" class="breadcrumb">articles</a><a href="/articles/HTTP" class="breadcrumb">HTTP</a><a href="/articles/HTTP/servers" class="breadcrumb">servers</a><a href="/articles/HTTP/servers/how-to-create-a-HTTPS-server" class="breadcrumb">how-to-create-a-HTTPS-server</a></div>
      <!--
        <div class="tags"></div>
        <div class="difficulty"></div>
      -->
    </div>
    <div usermodel_id="content"><p>To create an HTTPS server, you need two things: an SSL certificate, and Node's built-in <code>https</code> module.</p>
