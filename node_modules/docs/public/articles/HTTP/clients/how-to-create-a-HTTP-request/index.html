...
<body>
  ...
  <div usermodel_id="article">
    <div usermodel_id="metadata">
      ...
      <a href="/articles" class="breadcrumb">articles</a><a href="/articles/HTTP" class="breadcrumb">HTTP</a><a href="/articles/HTTP/clients" class="breadcrumb">clients</a><a href="/articles/HTTP/clients/how-to-create-a-HTTP-request" class="breadcrumb">how-to-create-a-HTTP-request</a></div>
      <!--
        <div class="tags"></div>
        <div class="difficulty"></div>
      -->
    </div>
    <div usermodel_id="content"><p>Another extremely common programming task is making an HTTP request to a web server.  Node.js provides an extremely simple API for this functionality in the form of <code>http.request</code>.</p>
