...
<body>
  ...
  <div usermodel_id="article">
    <div usermodel_id="metadata">
      ...
      <a href="/articles" class="breadcrumb">articles</a><a href="/articles/cryptography" class="breadcrumb">cryptography</a><a href="/articles/cryptography/how-to-use-crypto-module" class="breadcrumb">how-to-use-crypto-module</a></div>
      <!--
        <div class="tags"></div>
        <div class="difficulty"></div>
      -->
    </div>
    <div usermodel_id="content"><p>The <a href="http://nodejs.org/docs/v0.4.10/api/crypto.html">crypto</a> module is a wrapper for <a href="http://en.wikipedia.org/wiki/Openssl">OpenSSL</a> cryptographic functions. It supports calculating hashes, authentication with HMAC, ciphers, and more!</p>

<p>The crypto module is mostly useful as a tool for implementing <a href="http://en.wikipedia.org/wiki/Cryptographic_protocol">cryptographic protocols</a> such as <a href="http://en.wikipedia.org/wiki/Transport_Layer_Security">TLS</a> and <a href="http://en.wikipedia.org/wiki/Https">https</a>. For most users, Node's built-in <a href="http://nodejs.org/docs/v0.4.10/api/tls.html">tls module</a> and <a href="http://nodejs.org/docs/v0.4.10/api/https.html">https module</a> should more than suffice. However, for the usermodel that only wants to use small parts of what's needed for full-scale cryptography or is crazy/desperate enough to implement a protocol using OpenSSL and Node: Read on.</p>
