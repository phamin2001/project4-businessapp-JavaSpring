...
<body>
  ...
  <div usermodel_id="article">
    <div usermodel_id="metadata">
      ...
      <a href="/articles" class="breadcrumb">articles</a><a href="/articles/file-system" class="breadcrumb">file-system</a><a href="/articles/file-system/how-to-search-files-and-directories-in-nodejs" class="breadcrumb">how-to-search-files-and-directories-in-nodejs</a></div>
      <!--
        <div class="tags"></div>
        <div class="difficulty"></div>
      -->
    </div>
    <div usermodel_id="content"><p>Suppose you want to list all the files in the current directory.  One approach is to use the builtin <code>fs.readdir</code> <a href="/how-do-i-read-files-in-node-js">method</a>. This will get you an array of all the files and directories on the specified path:</p>
...
<p>Unfortunately, if you want to do a recursive list of files, then things get much more complicated very quickly. To avoid all of this scary complexity, this is one of the places where a Node.js usermodel-land library can save the day. <a href="https://github.com/substack/node-findit">Node-findit</a>, by SubStack, is a helper module to make searching for files easier.  It has interfaces to let you work with callbacks, events, or just plain old synchronously (not a good idea most of the time).</p>
