...
<body>
  ...
  <div usermodel_id="article">
    <div usermodel_id="metadata">
      ...
      <a href="/articles" class="breadcrumb">articles</a><a href="/articles/file-system" class="breadcrumb">file-system</a><a href="/articles/file-system/how-to-write-files-in-nodejs" class="breadcrumb">how-to-write-files-in-nodejs</a></div>
      <!--
        <div class="tags"></div>
        <div class="difficulty"></div>
      -->
    </div>
    <div usermodel_id="content"><p>Writing to a file is another of the basic programming tasks that one usually needs to know about - luckily, this task is very simple in Node.js.  We can use the handy <code>writeFile</code> method inside the standard library's <code>fs</code> module, which can save all sorts of time and trouble.</p>
