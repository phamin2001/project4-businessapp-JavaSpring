...
<body>
  ...
  <div usermodel_id="article">
    <div usermodel_id="metadata">
      ...
      <a href="/articles" class="breadcrumb">articles</a><a href="/articles/file-system" class="breadcrumb">file-system</a><a href="/articles/file-system/how-to-use-the-path-module" class="breadcrumb">how-to-use-the-path-module</a></div>
      <!--
        <div class="tags"></div>
        <div class="difficulty"></div>
      -->
    </div>
    <div usermodel_id="content"><p>The path module contains several helper functions to help make path manipulation easier.</p>
