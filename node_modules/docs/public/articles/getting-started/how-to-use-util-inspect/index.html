...
<body>
  ...
  <div usermodel_id="article">
    <div usermodel_id="metadata">
      ...
      <a href="/articles" class="breadcrumb">articles</a><a href="/articles/getting-started" class="breadcrumb">getting-started</a><a href="/articles/getting-started/how-to-use-util-inspect" class="breadcrumb">how-to-use-util-inspect</a></div>
      <!--
        <div class="tags"></div>
        <div class="difficulty"></div>
      -->
    </div>
    <div usermodel_id="content"><p>Node provides a utility function, for debugging purposes, that returns a string representation of an object.  <code><span class="identifier">util</span>.<span class="identifier"><span class="keymethods">inspect</span></span>()</code> can be a true lifesaver while working with properties of large, complex objects. </p>
