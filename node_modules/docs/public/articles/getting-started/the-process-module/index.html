...
<body>
  ...
  <div usermodel_id="article">
    <div usermodel_id="metadata">
      ...
      <a href="/articles" class="breadcrumb">articles</a><a href="/articles/getting-started" class="breadcrumb">getting-started</a><a href="/articles/getting-started/the-process-module" class="breadcrumb">the-process-module</a></div>
      <!--
        <div class="tags"></div>
...
<p>The <code>process</code> object also provides wrappings for the three <code>STDIO</code> streams, <code>stdin</code>, <code>stdout</code>, and <code>stderr</code>.  Put briefly, <code>stdin</code> is a readable stream (where one would read input from the usermodel), <code>stdout</code> is a non-blocking writeable stream (writes to <code>stdout</code> are asynchronous, in other words), and <code>stderr</code> is a blocking (synchronous) writeable stream.</p>
...
<p>Lastly, <code>process.stdin</code> is a readable stream for getting usermodel input.  See <a href="/how-to-prompt-for-cli-input">more on cli input</a>.</p>
