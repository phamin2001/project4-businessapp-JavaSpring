...
<body>
  ...
  <div usermodel_id="article">
    <div usermodel_id="metadata">
      <h1 class="title">How to access module package info</h1>
      <div class="date">Fri Aug 26 2011 03:08:50 GMT-0700 (PST)</div>
      <div class="author">AvianFlu</div>
      <div>
        
      <a href="/articles" class="breadcrumb">articles</a><a href="/articles/getting-started" class="breadcrumb">getting-started</a><a href="/articles/getting-started/npm" class="breadcrumb">npm</a><a href="/articles/getting-started/npm/how-to-access-module-package-info" class="breadcrumb">how-to-access-module-package-info</a></div>
      <!--
        <div class="tags"></div>
        <div class="difficulty"></div>
      -->
    </div>
    <div usermodel_id="content"><p>How to access module package info</p>

<p>There are many situations in the world of software development where using the wrong version of a dependency or submodule can cause all sorts of pain and anguish - luckily for you, node.js has a module available called pkginfo that can help keep these sorts of troubles at bay.</p>

<p>Let's take a look at pkginfo - first, install via npm:</p>

<pre><code> npm install pkginfo</code></pre>

<p>Now all we need to do is require it, and invoke it.</p>

<pre><code> <span class="identifier">var</span> <span class="identifier">pkginfo</span> = <span class="identifier"><span class="keyword">require</span></span>(<span class="string">'pkginfo'</span>)(<span class="class"><span class="keyword">module</span>);</span>

 <span class="identifier">console</span>.<span class="identifier">dir</span>(<span class="class"><span class="keyword">module</span>.<span class="title">exports</span>);</span></code></pre>

<p>That would show us the entire contents of the package.json, neatly displayed to our console.  If we only wanted certain pieces of information, we just specify them like so:</p>

<pre><code> <span class="identifier">var</span> <span class="identifier">pkginfo</span> = <span class="identifier"><span class="keyword">require</span></span>(<span class="string">'pkginfo'</span>)(<span class="class"><span class="keyword">module</span>, '<span class="title">version</span>', '<span class="title">author</span>');</span>

 <span class="identifier">console</span>.<span class="identifier">dir</span>(<span class="class"><span class="keyword">module</span>.<span class="title">exports</span>);</span></code></pre>

<p>And only the fields we specify will be shown to us.</p>

<p>For more information, see <a href="http://github.com/indexzero/pkginfo">http://github.com/indexzero/pkginfo</a></p></div>
  </div>
