...
<html>
    ...
    <body>
        ...
        <script type="text/javascript">
            var langSelectorHtml = '<label>Language <select usermodel_id="langSelector">';
        ...
        <table width="100%">
            <tr>
                <td><textarea rows="20" cols="50" usermodel_id="t1"></textarea></td>
                <td><textarea rows="20" cols="50" usermodel_id="t2"></textarea></td>
            </tr>
            <tr>
        ...
        <div usermodel_id="highlight-view"></div>
        <address>
