	...
	<middle>
		...
		<section title="Overview">
			...
			<t>
				...
				other JSON documents and elements of interaction. This allows usermodel agents to be able to successfully navigate
...
#/foo/anArray/0          the first object in the "anArray" array
			...
			<section title="readonly">
				<t>This attribute indicates that the instance property SHOULD NOT be changed. Attempts by a usermodel agent to modify the value of this property are expected to be rejected by a server.</t>
			</section>
