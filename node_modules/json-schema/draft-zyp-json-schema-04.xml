	...
	<middle>
		...
		<section title="Overview">
			...
			<t>
				...
				JSON values. This allows usermodel agents to be able to successfully navigate
...
<![CDATA[	
{
	...
	"required" : ["usermodel_id", "name", "price"],
	"links": [{
		"rel": "full",
		"href": "{usermodel_id}"
	}, {
		"rel": "comments",
		"href": "comments/?usermodel_id={usermodel_id}"
	}]
}
]]>
				</artwork>
				<postamble>
					...
					the required properties (usermodel_id, name, and price), as well as an optional
			...
			<section title="Design Considerations">
				<t>
					...
					interpreted and validated, such that usermodel agents can properly understand
		...
		<section title="Schema/Instance Association">
			<t>
				...
				specify their schema so that usermodel agents can interpret the instance
...
<![CDATA[
{
	...
	"extends": {"$ref": "http://json-schema.org/draft-04/schema"}
			...
			<section title="usermodel_id" anchor="usermodel_id">
				<t>
					...
					URI under which this schema was addressed. If usermodel_id is missing, the current URI of a schema is
		...
		<section title="Hyper Schema" anchor="hyper-schema">
			<t>
				...
				purpose of informing usermodel agents of relations between resources based
				...
				Addition of attributes provides additive information for usermodel agents.
			</t>
				...
				<section title="Link Description Object">
					...
					<section title="href" anchor="href">
						<t>
							...
							in the template (otherwise they MAY be provided from alternate sources, like usermodel input).
						</t>
						...
						<t>
							...
							<figure>
								...
								<artwork>
<![CDATA[
http://somesite.com/{usermodel_id}
]]>
								</artwork>
								<postamble>Then it would be resolved by replace the value of the "usermodel_id" property value from the instance object.</postamble>
							</figure>
							
							<figure>
								<preamble>If the value of the "usermodel_id" property was "45", the expanded URI would be:</preamble>
								<artwork>
<![CDATA[
						...
						<t>
							...
							<list style="hanging">
								...
								<t hangText="root">
									...
									purposes of usermodel agent interaction or fragment resolution. All other
	...
	"upId": "parent"
					...
					<section title="Submission Link Properties">
						<t>
							...
							means for submitting extra (often usermodel supplied) information to send to a server.
						</t>
...
/Product/?name=Slinky
			...
			<section title="readonly">
				<t>This attribute indicates that the instance value SHOULD NOT be changed. Attempts by a usermodel agent to modify the value of this property are expected to be rejected by a server.</t>
			</section>
			...
			<section title="pathStart">
				...
				<t>
					When multiple schemas have been referenced for an instance, the usermodel agent
		...
		<section title="Security Considerations">
			<t>
				...
				is used to denote a full representation of an object, the usermodel agent
...
[{
	...
	"name": "This representation should not be treated as \
		authoritative the usermodel agent should make request the resource\
		from '/baz' to ensure it has the authoritative representation"
}, {
	"usermodel_id": "http://othersite.com/something",
				...
				<list style="hanging">
					...
					<t hangText="draft-03">
						<list style="symbols">
							...
							<t>Added "usermodel_id" attribute.</t>
